...
// don't define TARGET_EE
#include "dsnet_prototypes.h"

// root/dsnet/dbg/dbg.c

extern int __cdecl load_word_registers(unsigned int *masks, unsigned int *pv, int n);
extern int __cdecl store_word_registers(unsigned int *masks, unsigned int *pv, int n);
...
extern int __cdecl load_word_reg(char *name, unsigned int *pv);
extern int __cdecl store_word_reg(char *name, unsigned int val);
...
extern int __cdecl look_iopmod(
        void *stream,
        DS_ELF_EHDR *ehdr,
        DS_ELF_SHDR *shdr,
        int id,
